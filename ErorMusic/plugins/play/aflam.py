...
async def action(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجــوع", callback_data="aflamAR2 " + str(m.from_user.id))],
        [InlineKeyboardButton("𝐒𝐎𝐔𝐑𝐂𝐄 𝐄𝐑𝐎𝐑", url=f"https://t.me/SOURCE_EROR")],
...
async def Xmos1(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجــوع", callback_data="moslsl " + str(m.from_user.id))],
        [InlineKeyboardButton("𝐒𝐎𝐔𝐑𝐂𝐄 𝐄𝐑𝐎𝐑", url=f"https://t.me/SOURCE_EROR")],
...
async def Xms1(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجــوع", callback_data="msrahia " + str(m.from_user.id))],
        [InlineKeyboardButton("𝐒𝐎𝐔𝐑𝐂𝐄 𝐄𝐑𝐎𝐑", url=f"https://t.me/SOURCE_EROR")],
        [InlineKeyboardButton("ضيـف البـوت لمجمـوعتـك ✅", url=f"https://t.me/{app.username}?startgroup=new")],
...
async def Xmsrh1(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("رجــوع", callback_data="Xms1 " + str(m.from_user.id))],
        [InlineKeyboardButton("𝐒𝐎𝐔𝐑𝐂𝐄 𝐄𝐑𝐎𝐑", url=f"https://t.me/SOURCE_EROR")],
        [InlineKeyboardButton("ضيـف البـوت لمجمـوعتـك ✅", url=f"https://t.me/{app.username}?startgroup=new")],
