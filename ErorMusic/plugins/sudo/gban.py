...
from ErorMusic.misc import SUDOERS
from ErorMusic.utils import get_readable_time
...
from ErorMusic.utils.extraction import extract_user
from config import BANNED_USERS


@app.on_message(command(["حظر عام", "احظره عام"]) & SUDOERS)
@language
...
@app.on_message(command(["الغاء حظر عام"]) & SUDOERS)
@language
...
@app.on_message(command(["gbannedusers", "المحظورين عام"]) & SUDOERS)
@language
