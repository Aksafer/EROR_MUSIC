...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("ErorMusic/assets/font2.ttf", 30)
    font = ImageFont.truetype("ErorMusic/assets/font.ttf", 30)
    title_font = ImageFont.truetype("ErorMusic/assets/font.ttf", 30)
    ...
    draw.text((500, 30), f"E r O r  M u S i C", fill="white", stroke_width=1, stroke_fill="black", font=font)
    ...
    play_icons = Image.open("ErorMusic/assets/play_icons.png")
